...
const file_profile_proto_rawDesc = "" +
	...
	"\x15ACCESS_STATUS_REVOKED\x10\x032\xaf\x01\n" +
	"\x0eProfileService\x12N\n" +
	"\x12GetProfilesByEmail\x12\x1a.profile.GetByEmailRequest\x1a\x1c.profile.GetProfilesResponse\x12M\n" +
	"\x12GetDossierUsername\x12\x1a.profile.GetByEmailRequest\x1a\x1b.profile.GetDossierResponseB<Z:github.com/Foxtrot-14/FitRang/analysis-service/proto;protob\x06proto3"
...
var file_profile_proto_depIdxs = []int32{
	...
	1, // 4: profile.ProfileService.GetDossierUsername:input_type -> profile.GetByEmailRequest
	2, // 5: profile.ProfileService.GetProfilesByEmail:output_type -> profile.GetProfilesResponse
	3, // 6: profile.ProfileService.GetDossierUsername:output_type -> profile.GetDossierResponse
